...
import { Button, VStack, Stack, Heading, Text } from '@chakra-ui/react'
        ...
        <Stack direction={['column', 'row']} h={"100vh"}>
            <VStack w={'full'}>
                ...
                <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
                    ...
                    <Text>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem nisi id odit ipsum nam
                        ratione distinctio.</Text>
                </VStack>
            </VStack>
